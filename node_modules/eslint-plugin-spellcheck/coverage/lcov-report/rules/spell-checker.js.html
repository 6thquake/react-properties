...
<html lang="en">
<head>
    <title>Code coverage report for rules/spell-checker.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">rules/</a> spell-checker.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-yes">32×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">29320×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1×</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">// Native modules
var fs = require('fs');
&nbsp;
...
&nbsp;
        ...
        function checkTemplateElement(aNode){
            <span class="missing-if-branch" title="else path not taken" >E</span>if(options.templates &amp;&amp; typeof aNode.value.raw === 'string') {
...
&nbsp;
        ...
        <span class="skip-if-branch" title="if path not taken" >I</span>if (isEslint4OrAbove(context)) {
<span class="cstat-skip" title="statement not covered" >          context</span>
            .getSourceCode()
            .getAllComments()
            .forEach(<span class="fstat-skip" title="function not covered" >function (commentNode) {</span>
<span class="cstat-skip" title="statement not covered" >              checkComment(commentNode);</span>
            });
        }
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Tue Mar 13 2018 00:48:25 GMT-0300 (-03)
</div>
</div>
